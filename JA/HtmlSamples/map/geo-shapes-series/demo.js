...
function ColorPickerByIndex(min, max) {
         ...
         $(function () {
            ...
            $("#map").igMap({
                ...
                overviewPlusDetailPaneBackgroundImageUri: "https://jp.staging.igniteui.com/19-2/images/samples/maps/world.png",
                series: [{
                    type: "geographicShape",
                    name: "worldCountries",
                    markerType: "none",
                    shapeMemberPath: "points",
                    shapeDataSource: 'https://jp.staging.igniteui.com/19-2/data-files/shapes/world_countries_reg.shp',
                    databaseSource: 'https://jp.staging.igniteui.com/19-2/data-files/shapes/world_countries_reg.dbf',
                    opacity: 0.8,
                    outlineThickness: 1,
                    showTooltip: true,
