                ...
                [
                    {
                        name: "button1",
                        header: "太字",
                        iconUri: "https://jp.staging.igniteui.com/19-2/images/samples/radial-menu/Bold.png",
                        click: function () { toggleBold(); }
                    },
                    {
                        name: "button2",
                        header: "イタリック",
                        iconUri: "https://jp.staging.igniteui.com/19-2/images/samples/radial-menu/Italic.png",
                        click: function () { toggleItalic(); }
                    },
                    {
                        type: "numericitem",
                        header: "フォント サイズ",
                        iconUri: "https://jp.staging.igniteui.com/19-2/images/samples/radial-menu/Size.png",
                        value: "8",
                        items:
                        [
                            {
